...
Write-Host "`nCleaning up old build snapshots..." -ForegroundColor Magenta
...
Write-Host "`nRemoving temporary and development files..." -ForegroundColor Magenta
$tempFiles = @(
    "temp-log-test.js",
    "test-report.xml", 
...
Write-Host "`nRemoving completed/legacy documentation..." -ForegroundColor Magenta
$legacyDocs = @(
...
Write-Host "`nCleaning up backup component files..." -ForegroundColor Magenta
...
Write-Host "`nOrganizing component variants..." -ForegroundColor Magenta
...
Write-Host "`nUpdating .gitignore..." -ForegroundColor Magenta
...
if ($Verbose -and $movedFiles.Count -gt 0) {
    Write-Host "`nMoved files:" -ForegroundColor Yellow
