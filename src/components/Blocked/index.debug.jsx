...
export class Blocked extends Component {
  ...
  componentDidMount() {
    ...
    if (hash && hash.includes('?')) {
      ...
      console.log(
        '[Blocked Page] Method 1 - Params from hash after ?:',
    ...
    // Method 2: Check if parameters are in the standard search part
      ...
      paramSource = 'search';
      console.log(
        '[Blocked Page] Method 2 - Params from search:',
        Object.fromEntries(params),
      );
    }
    // Method 3: Check all of the hash (for older versions)
      ...
      console.log(
        '[Blocked Page] Method 3 - Params from full hash:',
        Object.fromEntries(params),
      );
    } else {
    ...
    console.log(
      '[Blocked Page] Raw parsed values - URL:',
      parsedUrl,
      'Reason:',
      parsedReason,
    );
        ...
        if (items) {
          ...
          this.setState(
            ...
            () => {
              ...
              console.log(
                '[Blocked Page] State after storage.get - message:',
                this.state.message,
                'URL:',
                this.state.url,
                'Reason:',
          ...
          <div className="distract-cursor distract-select distract-overlay">
            <div className="distract-cursor distract-select distract-info-container">
              ...
              <div className="distract-debug-info">
                ...
                <ul>
                  <li>
                    <strong>Raw hash:</strong> {this.state.rawHash}
                  </li>
                  <li>
                    <strong>Raw search:</strong> {this.state.rawSearch}
                  </li>
                  <li>
                    <strong>Param source:</strong> {this.state.paramSource}
                  </li>
                </ul>
              </div>
              ...
              <div className="distract-block-reason">
                ...
                <span className="reason-text">
                  {this.state.reason &&
                  this.state.reason !== 'REASON_NOT_IN_URL_PARAMS' &&
