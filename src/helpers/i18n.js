...
const translations = isDevEnv
  ? require('../../public/_locales/en/messages')
  : {
      // Sync tab (formerly Diagnostic tab)
      sync: 'Sync',
      syncDescription:
        'Manage and monitor synchronization of your settings between devices.',
      ...
      syncDiagnosticsDescription:
        'Use these tools to diagnose and fix synchronization issues between your devices.',
      runDiagnosis: 'Check Sync Status',
      clearSyncStorage: 'Clear Sync Storage',
      confirmClearSync:
        'This will clear your synchronized settings. Local settings will remain. Continue?',
      ...
      syncSettingsNote:
        'Chrome/Edge sync storage has a limit of ~100KB. If you exceed this limit, settings may not sync properly.',
      ...
      youtubeDetectedDescription:
        'YouTube was found in your blacklist, which might be unintended. You can remove it manually if needed.',
      testSync: 'Test Sync',
